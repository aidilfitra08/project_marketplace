...
<body>
    ...
    <div class="container about">
        <h2 style="text-align: center">Update Your Account</h3><br><br>
        <div class="row">
            <form action="" method="post">
                    <div class="mb-3">
                        <label for="user_name" class="form-label">Username</label>
                        <input type="user_name" name="user_name" class="form-control" id="user_name" value="<?php if($session->get('user_name')) {echo $session->get('user_name');} ?>">
                    </div>
                    <div class="mb-3">
                        <label for="InputForPassword" class="form-label">Password</label>
                        <input type="password" name="password" class="form-control" id="InputForPassword" value="<?php if($session->get('user_name')) {echo $session->get('user_pass');} ?>">
                    </div>
                    <?php foreach($user as $z){ ?>
                    <div class="mb-3">
                        <label for="photo" class="form-label">Photo</label>
                        <?php echo $z['user_name']; ?>
                    </div>
                    <?php }; ?>
