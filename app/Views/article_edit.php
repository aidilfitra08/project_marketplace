...
<body>
    ...
    <div class="row justify-content-md-center" style="width: 100%;margin-top: 90px;">
        ...
        <div class="col-md-7" style="border: 1px solid black;">
            <h2>Edit Article</h2>
            <form action="/article/edit/<?= $a['article_id']; ?>" method="post">
                <label for="judul">Judul</label>
                <input type="text" name="judul" value="<?= $a['judul_article']; ?>">
                <br>
                <label for="writer">Writer</label>
                <input type="text" name="writer" value="<?= $a['article_writer']; ?>">
                
                <br>
                <label for="tulisan">Edit Tulisan</label>
                <textarea name="tulisan" id="" cols="150" rows="10" ><?= $a['article_text']; ?></textarea>
