...
<body>
    ...
    <div class="row barang" >
        ...
        <a href="/products/baju/<?= $b['product_id']; ?>" class="col-md-auto">
            <?php echo '<img src="data:image/jpeg;base64,'.base64_encode( $b['gambar_barang'] ).'" class="thumbnail">'; ?>
            <div class="caption" style="text-align: center;">
                <h5><?= $b['nama_product']; ?></h5>
                <h6><?= "Rp ".number_format($b['harga'],2,",","."); ?></h6>
            </div>
        </a>
        <?php }; ?>
        <a href="AllBaju.php" class="col-md-auto">
        ...
        <!--<a href="baju.html" class="col-md-auto">
