...
<body>
    ...
    <h2 style="text-align: center;">HATS</h2>
    ...
    <div class="row barang" >
        ...
        <a href="" class="col-md-auto">
            <img src="/gambar/product/topi/baseball2.jpeg" alt="" class="thumbnail">
            <div class="caption" style="text-align: center;">
                <h5>Nama Barang</h5>
                <h6>Harga</h6>
            </div>
        ...
        <a href="" class="col-md-auto">
            <img src="/gambar/product/topi/beret1.jpg" alt="" class="thumbnail">
            <div class="caption" style="text-align: center;">
                <h5>Nama Barang</h5>
                <h6>Harga</h6>
            </div>
        ...
        <a href="" class="col-md-auto">
            <img src="/gambar/product/topi/vedora1.webp" alt="" class="thumbnail">
            <div class="caption" style="text-align: center;">
                <h5>Nama Barang</h5>
                <h6>Harga</h6>
            </div>
